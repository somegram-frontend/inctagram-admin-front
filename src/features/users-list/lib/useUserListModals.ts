...
import { banUser, deleteUser, unbanUser } from "@/features/users-list/api";
import { toast } from "react-toastify";
import { useAppDispatch, useAppSelector } from "@/app/store";
import {
  getOpenedModalUserList,
  getSelectedUserList,
} from "@/features/users-list/model/user-list.selectors";
import {
  ModalType,
  userListActions,
} from "@/features/users-list/model/user-list.slice";
...
export const useUserListModals = () => {
  ...
  const user = useAppSelector(getSelectedUserList);
