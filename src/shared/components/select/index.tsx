...
type Props = Omit<ComponentPropsWithoutRef<typeof SelectRadix.Root>, keyof SelectProps> & SelectProps

export const Select = forwardRef<ComponentRef<typeof SelectRadix.Root>, Props>((props, ref) => {
      ...
      <SelectRadix.Root onValueChange={onValueChange} value={value} {...rest}>
        ...
        >
          ...
          <SelectRadix.Icon asChild className={'SelectIcon'}>
            <ArrowDown className={clsx(s.icon, disabled && s.iconDisabled)} name={'arrow'} />
          </SelectRadix.Icon>
        </SelectRadix.Trigger>
        <SelectRadix.Portal>
