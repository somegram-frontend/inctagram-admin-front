...
export const Select = forwardRef<ComponentRef<typeof SelectRadix.Root>, Props>(
  (props, ref) => {
    const {
      className,
      classNameContent,
        ...
        <SelectRadix.Root onValueChange={onValueChange} value={value} {...rest}>
          ...
          >
            ...
            <SelectRadix.Icon asChild className={"SelectIcon"}>
              <ArrowDown
                className={clsx(s.icon, disabled && s.iconDisabled)}
                name={"arrow"}
              />
            </SelectRadix.Icon>
          </SelectRadix.Trigger>
          <SelectRadix.Portal>
            <SelectRadix.Content
              className={clsx(s.content, classNameContent)}
              position={"popper"}
            >
